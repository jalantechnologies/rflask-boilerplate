...
class CleanupModuleReader:
    ...
    def get_cleanup_modules() -> List[CleanupModule]:
        ...
        cleanup_modules = [CleanupModuleModel(**cleanup_module_data) for cleanup_module_data in cleanup_modules_data]

        return [CleanupModuleUtil.convert_model_to_cleanup_module(cleanup_module) for cleanup_module in cleanup_modules]
