...
from modules.cleanup.types import AccountDeletionRequest, CreateAccountDeletionRequestParams


class AccountDeletionRequestReader:
    @staticmethod
    def check_account_deletion_request_exists(*, params: CreateAccountDeletionRequestParams) -> None:
        account_deletion_request = AccountDeletionRequestRepository.collection().find_one(
